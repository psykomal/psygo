...
- An attempt to self-study and learn computer internals through building
- Might be similar to a Master's in Computer Science but more custom-tailored, self-paced, freedom to choose your own path based on curiosity, focussed on practical and [reactive](https://manishearth.github.io/blog/2017/05/19/teaching-programming-proactive-vs-reactive/) learning. (Note: reactive learning as referred here is something different)
- It is not a replacement for a college Master's. 
...
3. Demystify the tools and underlying systems I use everyday - OS, compilers, database, networks, etc. I totally agree with [Julia Evans](https://jvns.ca/about/) that this is the only way to do technically innovative work and its a lot of fun
...
2. **Colleges impose competition over learning**. Students are incentivized by design (both by structure and [**mimesis**](https://psyche.co/guides/how-to-know-what-you-really-want-and-be-free-from-mimetic-desire)) to study for better grades and jobs. Designed properly, it might even help learn but is the stress necessary? I do not have anything against competition, but I believe being aware of where it is required is helpful. It misleads the unconscious to think life is a [zero-sum game](https://twitter.com/naval/status/1267179384886095873?s=20) and has implications on mental health as well.
...
4. **Extra time** - The time freed by not stressing over exams and unwanted courses mean free time to either have a day job or work on a side business or improve other skills I lack, write a blog, focus on health, etc. Replace **zero-sum** with **positive-sum** games. Also, actually focus on learning.
...
3. More specific resources included in my other [posts](https://www.psykomal.com/posts/) (will keep updating) - [Compilers](https://www.psykomal.com/posts/why-learn-compilers/)
...
4. [Learning in Public](https://www.swyx.io/learn-in-public) is a nice strategy - By sharing our learning, writing blogs, micro posts (twitter, mastodon), and videos with people of similar interests, everyone wins. Social Consistency and Approval are strong motivators. And will also open up unexpected doors and opportunities.
5. [Recurse Center's all 3 Self-Directives](https://www.recurse.com/self-directives)
...
## [Recurse Center](https://www.recurse.com/) - The retreat where curious programmers recharge and grow
...
3. Many of the past recursers have done things I am interested in
